...
public class Ai_V4 {
    ...
    public final static String aiName = " [인공지능 프로그램 V4]";
    ...
    public static ArrayList<Double> visitorInput() {
        ...
        do {
            ...
            input2 = Input.input();
            if (Validation.isValid(input2)) {
                inputVisitor = Double.parseDouble(input2);
                ...
                System.out.println("[안내]인원수를 숫자로 `터입력하여 주세요.");
                boolean1 = -2;
            }
        }
        while (!(boolean1 == -1));
